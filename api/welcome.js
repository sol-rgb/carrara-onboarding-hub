// ⚠️ POPS CONTRACT (see AGENTS.md): codes decoded here are already in hires'
// inboxes, and the plan fetch below calls POps' /api/hub-plan with
// POPS_PLAN_TOKEN — ask Eric before changing code semantics or the plan seam.
//
